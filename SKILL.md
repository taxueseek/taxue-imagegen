...
| `references/poster-horizontal-series.md` | 类型 A 的**两支横版母版**（与竖版的 poster-v5 互不通用，彼此也互不通用）：§一–§五 H 系 3:2 限色平印人物（骨架+十一槽位+11 风格完整槽位表）；§六 复古宣传画 2.5:1 四色木刻（骨架+槽位表+已验证两版） |
